...
from patternpiece import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "PatternPiece"
copyright = f"{datetime.today().year}, ZJU MMF"
author = "Lvxiaowei Xu, Zhiling Gong, Tianxiang Wang"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/xlxwalex/PatternPiece",
            "html": """
