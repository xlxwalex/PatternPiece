...
1. **Initial setup** (only do this once)
    ...
    Then clone your fork locally with
        ...
        git clone https://github.com/USERNAME/PatternPiece.git

    or 

        git clone git@github.com:USERNAME/PatternPiece.git

    At this point the local clone of your fork only knows that it came from *your* repo, github.com/USERNAME/PatternPiece.git, but doesn't know anything the *main* repo, [https://github.com/xlxw/PatternPiece.git](https://github.com/xlxw/PatternPiece). You can see this by running

        git remote -v

    which will output something like this:

        origin https://github.com/USERNAME/PatternPiece.git (fetch)
        origin https://github.com/USERNAME/PatternPiece.git (push)

    This means that your local clone can only track changes from your fork, but not from the main repo, and so you won't be able to keep your fork up-to-date with the main repo over time. Therefore you'll need to add another "remote" to your clone that points to [https://github.com/xlxw/PatternPiece.git](https://github.com/xlxw/PatternPiece). To do this, run the following:

        git remote add upstream https://github.com/xlxw/PatternPiece.git

    Now if you do `git remote -v` again, you'll see

        origin https://github.com/USERNAME/PatternPiece.git (fetch)
        origin https://github.com/USERNAME/PatternPiece.git (push)
        upstream https://github.com/xlxw/PatternPiece.git (fetch)
        upstream https://github.com/xlxw/PatternPiece.git (push)
    ...
    Then you can create and activate a new Python environment by running:
        ...
        conda create -n patternpiece python=3.9
        conda activate patternpiece
...
2. **Ensure your fork is up-to-date**
    ...
    Once you've added an "upstream" remote pointing to [https://github.com/allenai/python-package-temlate.git](https://github.com/xlxw/PatternPiece), keeping your fork up-to-date is easy:
...
4. **Test your changes**
    ...
    Our continuous integration (CI) testing runs [a number of checks](https://github.com/xlxw/PatternPiece/actions) for each pull request on [GitHub Actions](https://github.com/features/actions). You can run most of these tests locally, which is something you should do *before* opening a PR to help speed up the review process and make it easier for us.
